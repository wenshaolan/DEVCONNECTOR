import React, {Fragment, useState, useNavi} from 'react'
...
const AddEducation = ({addEducation, history}) => {
    ...
    const [toDateDisable, togglefDisabled]=useState(false);
    ...
    <Fragment>
      ...
      <form class="form" onSubmit={e=>{
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          <p><input type="checkbox" check={current} name="current" value={current} 
          onChange={e=>{
            setFormData({...formData, current: !current}); 
            togglefDisabled(!toDateDisable);
        }} /> {' '}Current Job</p>
        </div>
        <div class="form-group">
          <h4>To Date</h4>
          <input type="date" name="to" value={to} 
          onChange={e=>onChange(e)} disabled={toDateDisable?'disable': ''} />
        </div>
        <div class="form-group">
          <textarea
            name="description"
